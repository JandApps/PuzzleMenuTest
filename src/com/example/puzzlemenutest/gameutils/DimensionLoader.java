...
public class DimensionLoader {
	...
	private void loadDimensions() {
		addByIds(R.string.difficult_easy, R.integer.easy_rows,
				R.integer.easy_columns);
		addByIds(R.string.difficult_medium, R.integer.medium_rows,
				R.integer.medium_columns);
		addByIds(R.string.difficult_hard, R.integer.hard_rows,
				R.integer.hard_columns);
	}
